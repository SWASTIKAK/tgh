...
function setup() {
  ...
  //creating empty groups for our balloon and arrow functions
  redB = new Group();
  pinkB = new Group();
  blueB = new Group();
  greenB = new Group();
...
function draw() {
 ...
 background(0);
  ...
  if (World.frameCount % 100 == 0) {
   ...
   //destroying arrow annd ballon once they collide and giving points
